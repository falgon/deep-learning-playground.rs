...
pub fn load_data<'a>(dataset_key: DatasetKey, normalize: bool) -> io::Result<vec::Vec<MnistImage>> {
    ...
    for i in 0..images_data.sizes[0] as usize {
        ...
        let image_data = compute_normalize(image_data);
        images.push(Array2::from_shape_vec((1, image_shape), image_data).unwrap());
    }
